 ...
 * how to split a publisher into multiple and how to keep history so late
 * subscriber don't miss any updates.
 *
 * Read first:
 *
...
public class c12_Broadcasting extends BroadcastingBase {
    ...
    /**
     * Split incoming message stream into two streams, one contain user that sent
     * message and second that contains
     * message payload.
     */
    @Test
    ...
    /**
     * Since two subscribers are interested in the updates, which are coming from
     * same source, convert `updates` stream
     * to from cold to hot source.
     * Answer: What is the difference between hot and cold publisher? Why does won't
     * .share() work in this case?
     */
    @Test
    ...
    /**
     * In previous exercise second subscriber subscribed to update later, and it
     * missed some updates. Adapt previous
     * solution so second subscriber will get all updates, even the one's that were
     * broadcaster before its
     * subscription.
     */
    @Test
